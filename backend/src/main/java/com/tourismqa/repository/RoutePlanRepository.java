...
public interface RoutePlanRepository extends JpaRepository<RoutePlan, Long> {
    ...
    List<RoutePlan> findByUser_Id(Long userId);

    Optional<RoutePlan> findByIdAndUser_Id(Long id, Long userId);

    List<RoutePlan> findByConversation_Id(Long conversationId);
}
